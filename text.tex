...
Všechny tyto programy jsou propojeny síťovými sockety zprostředkovanými knihovnou ZeroMQ, která nabízí \footnote{Ve frontě jsou zprávy seřazeny od té nejdříve odeslané.}{frontu} zpráv, bez potřeby samostatně běžícího brokeru.\fxnote{TODO: divna jednicka}
