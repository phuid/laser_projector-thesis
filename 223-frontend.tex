...
Pokud narazí na aktivní položku menu, jejíž atribut \mintinline{cpp}{style} je roven \mintinline{cpp}{VALUE}. V takovém případě se změní hodnota, kterou tato položka menu reprezentuje.
