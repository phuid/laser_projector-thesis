...
Obvody byly navrženy v~programu KiCad, celé schéma desky je~k~nalezení v~příloze~7.1 na~konci tohoto dokumentu. Další výrobní dokumenty z~programu KiCad jsou k~nalezení v~souborové příloze ve~složce \uv{pcb}. Následně pro~ně v~tomtéž programu byla nadesignována deska plošných spojů. Mezi obvody patří:
\begin{itemize}
