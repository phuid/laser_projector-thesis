...
V mém kódu tudíž používám funkci \mintinline{js}{execSync} k zastavení služeb hostapd a dnsmasq následovně \mintinline{js}{execSync("sudo systemctl disable dnsmasq")}.
