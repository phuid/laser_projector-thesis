...
Diferenciální signál je signál přenášený dvěmi vodiči, každý z nich přenáší stejný signál, jen s opačnou polaritou. Kontakt označený $(+)$ je brán za nosič základního signálu, zatímco kontakt označený $(-)$ je brán za nosič obráceného signálu. Výsledné diferenciální napětí je napětí na základním nosiči vůči napětí na obráceném nosiči, tzn.~$V = V_{(+)} - V_{(-)}$
