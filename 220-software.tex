...
Mezi tyto programy patří program lasershow, který obsluhuje vykreslování, programy pro interakci s uživatelem (dále \uv{UI programy}) jako UI, web_ui a discord_bot, a také program wifi_manager, který spravuje wifi připojení Raspberry Pi.
