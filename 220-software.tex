...
Mezi tyto programy patří program lasershow, který obsluhuje vykreslování, programy pro interakci s uživatelem (dále \uv{UI programy}) jako UI, web\_ui a discord\_bot, a také program wifi\_manager, který spravuje wifi připojení Raspberry Pi.
